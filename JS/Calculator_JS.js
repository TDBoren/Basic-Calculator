...
const Calculator = {
    ...
    Display_Value: '0',
    // this will hold the first operand dor any expressions, we set it to null for now
    First_Operand: null,
    // this checks whether or not the second operand has benn input
...
function Input_Digit(digit) {
    ...
    // we are checking to see if the Wait_Second_Operand is true and set
...
// this function updates the swcreen with the contents of Display_Value
